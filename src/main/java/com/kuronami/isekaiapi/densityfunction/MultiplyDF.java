...
public record MultiplyDF(DensityFunction a, DensityFunction b) implements DensityFunction.SimpleFunction {
    ...
    public static final KeyDispatchDataCodec<MultiplyDF> KEY_CODEC = new KeyDispatchDataCodec<>(CODEC);
