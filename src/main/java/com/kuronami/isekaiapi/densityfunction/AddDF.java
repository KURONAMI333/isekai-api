...
public record AddDF(DensityFunction a, DensityFunction b) implements DensityFunction.SimpleFunction {
    ...
    public static final KeyDispatchDataCodec<AddDF> KEY_CODEC = new KeyDispatchDataCodec<>(CODEC);
